...
namespace ZDMesInterfaces.LBJ.BHDGL
{
    ...
    public interface IDeal4MBHD
    {
        ...
        /// <returns></returns>
        IEnumerable<lbj_qms_4mbhd> Get_Bhzx_BHD_List(sys_page parm, out int resultcount);
        /// <summary>
        /// 操作员变化点列表
        /// </summary>
        /// <param name="parm"></param>
        ...
        /// <returns></returns>
        bool Save_ZC_BHD_Deal(lbj_qms_4mbhd entity);
        /// <summary>
        /// 保存变化执行
        /// </summary>
        /// <param name="entity"></param>
        /// <returns></returns>
        bool Save_BhZx_BHD_Deal(lbj_qms_4mbhd entity);
        /// <summary>
        /// 保存操作员变化点处理信息
        /// </summary>
        /// <returns></returns>
