...
namespace ZDMesServices.TJ.A1.RYGL
{
    public class A1RyxxService:BaseDao<zxjc_ryxx>, IRYGL
    {
        ...
        //    {
        //        StringBuilder sql = new StringBuilder();
        //        sql.Append("update zxjc_ryxx set scbz='Y',lzrq=sysdate where user_code in :usercode and scbz='N' ");
        //        var usercodes = entitys.Select(t => t.usercode).ToList();
        //        using (var db = new OracleConnection(ConString))
        //        {
        //            return db.Execute(sql.ToString(), new { usercode = usercodes })>0;
        //        }
        //    }
        //    catch (Exception)
        //    {
