    ...
    public class ZpJhService :BaseDao<pp_zpjh>
    {
        ...
        public override IEnumerable<pp_zpjh> GetList(sys_page parm, out int resultcount)
        {
            try
            {
                ...
                sql.Append(" from pp_zpjh where scx in ('J503','J504','J505','J507','J512') ");
                StringBuilder sql_cnt = new StringBuilder();
                sql_cnt.Append($"select count(*) from pp_zpjh where scx in ('J503','J504','J505','J507','J512') ");
                ...
                else
                {
                    ...
                    {
                        sql.Append($" order by jhsj desc,scx asc ");
                    }
                }
